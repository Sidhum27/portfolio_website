...
This is Manjit, my latest, greatest, and quite possibly most unique template for HTML5 UP.
...
Manjit, which combines a robust side-scrolling framework of my own creation (with various
...
Instructions:
	...
	========
		...
		Manjit does two things to work around this:
		...
		- Scroll Wheel: Manjit modifies* the scroll wheel's behavior to translate vertical
	...
	==============
		...
		Manjit includes span modifiers ranging from 0.25 units ("span-0-25") to 10 units
	...
	==============
		...
		Most of Manjit's elements are pretty much what you'd expect, but there are a handful
		...
		------
			...
			The primary building block of Manjit.
